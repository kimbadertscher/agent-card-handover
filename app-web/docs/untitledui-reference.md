> **Project override:** this is Untitled UI's generic guide (from github.com/untitleduico/react). Where it says to edit `src/styles/theme.css` (e.g. *Brand Color Customization*), don't — in this repo styling comes from Figma variables via `/sync-tokens` (see CLAUDE.md).
