...
export const styles = sortCx({
    ...
    sizes: {
        ...
        md: {
            root: [
                "gap-1 rounded-full px-4 py-2.5 text-md font-semibold before:rounded-full data-icon-only:p-2.5",
                "in-data-input-wrapper:gap-1.5 in-data-input-wrapper:px-4 in-data-input-wrapper:text-md in-data-input-wrapper:data-icon-only:p-3",
            ].join(" "),
            linkRoot: "gap-1 *:data-text:underline-offset-4",
        },
        lg: {
            // iOS large button: 50 high, Text lg/Semibold
            root: "h-12.5 gap-1.5 rounded-full px-5 text-lg font-semibold before:rounded-full data-icon-only:w-12.5 data-icon-only:p-0",
            linkRoot: "gap-1.5 *:data-text:underline-offset-4",
        },
        xl: {
            root: "h-14 gap-1.5 rounded-full px-6 text-lg font-semibold before:rounded-full data-icon-only:w-14 data-icon-only:p-0",
            linkRoot: "gap-1.5 *:data-text:underline-offset-4",
        },
    },
    ...
    colors: {
        primary: {
            // Viseca one: flat black pill, no shadow / ring / inner gradient.
            root: ["bg-brand-solid text-white hover:bg-brand-solid_hover data-loading:bg-brand-solid_hover", "*:data-icon:text-white"].join(" "),
        },
        secondary: {
            // Viseca one: flat grey pill, no ring / border.
            root: ["bg-tertiary text-primary hover:bg-quaternary data-loading:bg-quaternary", "*:data-icon:text-primary"].join(" "),
        },
        tertiary: {
            root: ["text-primary hover:bg-tertiary data-loading:bg-tertiary", "*:data-icon:text-primary"].join(" "),
        },
        "link-color": {
            root: [
        ...
        "primary-destructive": {
            root: ["bg-error-solid text-white outline-error hover:bg-error-solid_hover data-loading:bg-error-solid_hover", "*:data-icon:text-white"].join(" "),
        },
        "secondary-destructive": {
            root: [
                "bg-tertiary text-error-primary outline-error hover:bg-quaternary data-loading:bg-quaternary",
                "*:data-icon:text-fg-error-secondary hover:*:data-icon:text-fg-error-primary",
            ].join(" "),
        },
        "tertiary-destructive": {
            root: [
                // Viseca one: red text only, grey hover (no red backgrounds)
                "text-error-primary outline-error hover:bg-tertiary data-loading:bg-tertiary",
                // Icon styles
                "*:data-icon:text-fg-error-secondary hover:*:data-icon:text-fg-error-primary",
            ].join(" "),
        },
